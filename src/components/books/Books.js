        ...
        <Row className="pt-4">
          ...
          <Col md={6} lg={7}>
            <div>
              ...
              <h4 className="fw-normal mb-4">A Hermeneutical Investigation of Al-Khidr</h4>
          ...
          <Carousel fade className="book-reviews border py-5 mt-3 rounded shadow-sm">
              ...
              <Row className="justify-content-center flex-sm-row-reverse">
                ...
                <Col md={4} lg={2}>
                  <figure className="text-center mt-4 mt-sm-0">
                    ...
                    <figcaption><small>Marquette University, Milwaukee, USA</small></figcaption>
                  </figure>
                </Col>
              </Row>
            </Carousel.Item>
            <Carousel.Item>
              <Row className="justify-content-center flex-sm-row-reverse">
                <Col md={6} lg={8}>
                  <div className="d-flex flex-column justify-content-center h-100">
                    <blockquote className="text">"The Qur’anic Dilemma is a beautifully written, fascinating and brave book that takes the reader on a journey into one of the most controversial and wicked questions of Islam: How to reconcile the Qur’anic message of social justice and humanity with elements that seem to portray infidelity as a justification for killing? Through her analysis of the controversial (and often misunderstood) Qur’anic story about al-Khidr, Abla Hasan convincingly finds the solution to this dilemma in the Qur’an itself – a solution that centers the Qur’an’s deeply humanitarian message and challenges purposively politicising interpretations of both militant Islamists as well as Islamophobes from around the world. This book is highly engaging and deserves a broad readership, within and beyond Islamic Studies, within and beyond academia, and everyone interested in religious pluralism and co-existence."</blockquote>
                  </div>
                </Col>
                <Col md={4} lg={2}>
                  <figure className="text-center mt-4 mt-sm-0">
                    ...
                    <figcaption><small>Victoria University, Melbourne</small></figcaption>
                    <figcaption><small>Author of Muslim Citizenship in Liberal Democracies</small></figcaption>
                  </figure>
                </Col>
              </Row>
            </Carousel.Item>
              ...
              <Row className="justify-content-center flex-sm-row-reverse">
                ...
                <Col md={4} lg={2}>
                  <figure className="text-center mt-4 mt-sm-0">
                    ...
                    <figcaption><small>University of Nebraska-Lincoln, Nebraska, USA</small></figcaption>
                  </figure>
                </Col>
              </Row>
            </Carousel.Item>
