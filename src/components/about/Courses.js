      ...
      <Row 
        ...
        <Col>
          <ListGroup variant="flush">
            ...
            <ListGroup.Item><GoPrimitiveDot /> Honors MODL 189 H “Arab intellectuals on love and gender” ACE 5. <a href="https://mediahub.unl.edu/media/12744" className="text-gray-blue" target="_blank" rel="noreferrer">A link to a video</a> </ListGroup.Item>
          </ListGroup>
        </Col>
      </Row>
